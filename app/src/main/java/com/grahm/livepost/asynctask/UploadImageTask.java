...
public class UploadImageTask extends AsyncTask<Uri, String, String> {
    ...
    public UploadImageTask(Context context, String name, OnPutImageListener listener, Boolean showDialog) {
        mContext = context;
        mListener = listener;
