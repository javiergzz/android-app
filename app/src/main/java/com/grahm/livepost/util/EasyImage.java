...
import com.grahm.livepost.util.BundleKeys;
...
public class EasyImage implements EasyImageConfig {
    ...
    private static Intent createVideoFromDocumentsIntent(Context context, int type) {
        storeType(context, type);
        Intent intent = new Intent(Intent.ACTION_GET_CONTENT);
    ...
    private static Intent createChooserIntent(Context context, String chooserTitle, boolean showGallery, int type) throws IOException {
        ...
        Uri outputVideoUri = createCameraVideoFile(context);
        ...
        for (ResolveInfo res : camList) {
            ...
            final Intent videoDocsIntent = createVideoFromDocumentsIntent(context, type);
            cameraIntents.add(videoDocsIntent);
        }
    ...
    public static void clearConfiguration(Context context) {
        PreferenceManager.getDefaultSharedPreferences(context).edit()
                .remove(pl.aprilapps.easyphotopicker.BundleKeys.FOLDER_NAME)
                .remove(pl.aprilapps.easyphotopicker.BundleKeys.FOLDER_LOCATION)
                .remove(pl.aprilapps.easyphotopicker.BundleKeys.PUBLIC_TEMP)
                .apply();
    }
    ...
    public static class Configuration {
        ...
        public Configuration setImagesFolderName(String folderName) {
            PreferenceManager.getDefaultSharedPreferences(context)
                    .edit().putString(pl.aprilapps.easyphotopicker.BundleKeys.FOLDER_NAME, folderName)
                    .commit();
            return this;
        }
        ...
        public Configuration saveInRootPicturesDirectory() {
            PreferenceManager.getDefaultSharedPreferences(context).edit()
                    .putString(pl.aprilapps.easyphotopicker.BundleKeys.FOLDER_LOCATION, EasyImageFiles.publicRootDir(context).toString())
                    .commit();
            return this;
        }
        ...
        public Configuration saveInAppExternalFilesDir() {
            PreferenceManager.getDefaultSharedPreferences(context).edit()
                    .putString(pl.aprilapps.easyphotopicker.BundleKeys.FOLDER_LOCATION, EasyImageFiles.publicAppExternalDir(context).toString())
                    .commit();
            return this;
        }
