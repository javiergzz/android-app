...
public class GV {
    // INFO.- Variables de Amazon.
    public static final String BASE_URL_AMAZON = "https://livepostrocks.s3.amazonaws.com/";
    ...
    public static final String PICTURE_BUCKET = "livepostrocks/images";
    public static final String VIDEO_BUCKET = "livepostrocks/videos";
    public static final String DEV_BUCKET = "livepostrocks/dev";
